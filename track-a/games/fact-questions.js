...
const FACT_QUESTIONS = [
  {
    ...
    summary: "송편은 추석의 대표 음식이에요.",
    hint: "'~만'이라는 말이 맞는지 한 번 더 살펴보세요.",
    source: "국립민속박물관",
    teacherQuestions: [
      "'송편만'이라는 말에서 이상한 부분은 없을까요?",
      "송편 말고 다른 음식은 없을까요?",
      "단서를 본 뒤 처음 생각이 달라졌나요?"
    ],
    images: {
      clue1: "🍡", // 송편
      clue2: "🌾" // 햇곡식
  ...
  },
  {
    ...
    summary: "추석 무렵에는 햇곡식과 햇과일을 준비하기도 해요.",
    hint: "추석이 가을에 있는 명절이라는 점을 생각해 보세요.",
    source: "국립민속박물관",
    teacherQuestions: [
      "추석은 어느 계절의 명절인가요?",
      "가을에는 어떤 것들을 준비할 수 있을까요?",
      "우리의 처음 생각과 다른 이야기는 무엇인가요?"
    ],
    images: {
      clue1: "🌾", // 곡식
      clue2: "🍎" // 과일
  ...
  },
  {
    ...
    summary: "차례 음식은 집안이나 지역에 따라 달라질 수 있어요.",
    hint: "전통이 지역과 가정마다 조금씩 다를 수 있다는 생각을 해보세요.",
    source: "국립민속박물관",
    teacherQuestions: [
      "모든 집의 차례 음식이 같을까요?",
      "우리 지역과 다른 지역의 음식이 다르다면, 어떤 차이가 있을까요?",
      "차례 음식이 같지 않다면, 전통이란 무엇일까요?"
    ],
    images: {
      clue1: "🏠", // 집
      clue2: "🗺️" // 지역
  ...
  },
  {
    ...
    summary: "널리 알려진 차례상 방식이 모두에게 반드시 같은 규칙은 아니에요.",
    hint: "널리 알려진 방식과 반드시 지켜야 하는 규칙은 다를 수 있어요.",
    source: "국립민속박물관",
    teacherQuestions: [
      "'반드시'라는 말은 무엇을 의미할까요?",
      "널리 알려진 방식이라는 것과 반드시 지켜야 한다는 것은 다를까요?",
      "전통은 한 가지의 규칙일까요?"
    ],
    images: {
      clue1: "🍜", // 음식
  ...
  },
  {
    ...
    summary: "강강술래는 손을 잡고 둥글게 돌며 노는 전통 놀이예요.",
    hint: "강강술래의 모습을 떠올려 보세요.",
    source: "유네스코",
    teacherQuestions: [
      "강강술래에서 '손을 잡고'와 '둥글게'는 특별한 의미가 있을까요?",
      "유네스코에서 보호하는 이유는 무엇일까요?",
      "우리나라의 전통 놀이를 더 알고 싶으신가요?"
    ],
    images: {
      clue1: "👥", // 사람들
      clue2: "⭕" // 원
